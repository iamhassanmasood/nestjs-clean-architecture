...
import { Author, AuthorDocument, Book, BookDocument, Genre, GenreDocument } from "./model";
...
export class MongoDataServices implements IDataServices, OnApplicationBootstrap {
  ...
  onApplicationBootstrap() {
    ...
    this.books = new MongoGenericRepository<Book>(this.BookRepository, ["author", "genre"]);
